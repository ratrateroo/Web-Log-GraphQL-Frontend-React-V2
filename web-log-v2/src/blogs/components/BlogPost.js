               ...
               <div className="c-blog-comments__body">
                  <form action="" className="c-comments-form">
                     ...
                     <div className="c-comments-form__button">
                        <button type="submit" className="c-comments-form__button-submit">
                           Add Comment
                        </button>
                     </div>
                  </form>
                  ...
                  <ul className="c-blog-comments__messages-items">
                     <li className="c-blog-comments__messages-item">
                        <p className="c-blog-comments__message">
                           ...
                           assumenda odit labore maiores, accusamus ipsa ipsum iure adipisci
                           veritatis quod quibusdam voluptatem, repellat optio fugit debitis! Iusto
                           accusamus sapiente id. Lorem ipsum dolor sit amet consectetur adipisicing
                           elit. Accusantium assumenda odit labore maiores, accusamus ipsa ipsum
                           iure adipisci veritatis quod quibusdam voluptatem, repellat optio fugit
                           debitis! Iusto accusamus sapiente id.
                        </p>
                     ...
                     <li className="c-blog-comments__messages-item">
                        <p className="c-blog-comments__message">
                           Eveniet cumque ratione alias, fuga quae cupiditate quasi perspiciatis,
                           delectus beatae commodi nulla sequi ex corporis qui repudiandae!
                           Quibusdam dicta corrupti, doloremque sunt repellendus dolores autem
                           expedita tempore dolor aspernatur? Laudantium sunt natus quas illum
                           eaque, expedita architecto officiis qui vel quo eligendi ipsam? Cum iure
                           obcaecati aperiam reiciendis enim ea libero architecto excepturi ut,
                           dolorum, iusto magni necessitatibus dolor. Lorem ipsum, dolor sit amet
                           consectetur adipisicing elit. Quae voluptas illum explicabo inventore,
                           provident adipisci cupiditate pariatur, iusto recusandae ipsa odio ipsum
                           deleniti vitae possimus eaque odit, animi accusamus quia.
                        </p>
                        <div className="c-blog-comments__message-info">
                           <div className="c-blog-comments__user-created">
                              <div className="c-blog-comments__user-created-icon">
                     ...
                     <li className="c-blog-comments__messages-item">
                        <p className="c-blog-comments__message">
                           Quaerat molestias, ab cum, maiores expedita architecto corporis delectus
                           perferendis animi optio modi cumque consectetur nulla aspernatur eligendi
                           ad eveniet ipsam dolore laboriosam tempore inventore alias quasi!
                           Officia, exercitationem nobis. Eveniet voluptatibus consectetur, eligendi
                           quos modi accusantium odio incidunt dolore magni tenetur labore odit non
                           ullam atque voluptatem adipisci impedit optio rerum sapiente voluptate
                           laboriosam libero ab iure minus! Doloribus!
                        </p>
                        <div className="c-blog-comments__message-info">
                           <div className="c-blog-comments__user-created">
                              <div className="c-blog-comments__user-created-icon">
